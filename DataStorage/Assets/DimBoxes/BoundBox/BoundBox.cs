...
namespace DimBoxes
{
    ...
    public class BoundBox : MonoBehaviour
    {
        ...
        void Start()
        {
            cameralines = (DimBoxes.DrawLines)FindObjectOfType(typeof(DimBoxes.DrawLines));
        ...
        {
            //Debug.Log("enabled box called");
            box_enable = true;
        }

        public void UnableBox()
        {
            box_enable = false;
        }
